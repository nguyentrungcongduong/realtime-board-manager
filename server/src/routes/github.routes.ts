...
// GET /api/github/callback  — OAuth callback (user is already authed via JWT in query/state)
router.get('/callback', authMiddleware, githubController.handleCallback);
